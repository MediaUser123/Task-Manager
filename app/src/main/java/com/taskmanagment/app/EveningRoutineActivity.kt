...
import com.taskmanagment.app.databinding.ActivityEveningRoutineBinding

class EveningRoutineActivity : AppCompatActivity() {
    lateinit var binding: ActivityEveningRoutineBinding
    lateinit var adapter: MyroutineAdpater
    var arraylist: ArrayList<MyroutineModel> = arrayListOf()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=ActivityEveningRoutineBinding.inflate(layoutInflater)
